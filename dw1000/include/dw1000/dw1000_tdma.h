...
#define dw1000_dwt_usecs_to_usecs(_t) (float)( _t * (0x10000/(128*499.2)))             //!< Converts DWT_usecs to usecs
#define dw1000_usecs_to_dwt_usecs(_t) (float)( _t * dw1000_dwt_usecs_to_usecs(1.0))    //!< Converts usecs to DWT_usecs 
