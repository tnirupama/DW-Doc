...
/** 
 * This function initializes the tdma instance. Sets the clkcal postprocess and 
...
/**
 * This function free memory allocated for tdma slots.
 *
...
#ifdef TDMA_TASKS_ENABLE
/**
 * This function initializes a higher priority task for the tdma slot tasks.
 *
...
/**
 * This is the task function for the tdma.
 *
...
#endif
/**
 * This function intializes slot instance for the slot.Also initializes a timer and assigns callback for each slot.
 *
 * @param inst       Pointer to _tdma_instance_t*.
...
/** 
 * @brief This is the callback function assigned for the zeroth slot.
...
/**
 * @brief This is the timer callback assigned for each slot. This function then puts
